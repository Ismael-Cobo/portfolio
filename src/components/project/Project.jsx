      ...
      <div className='projects__content'>
        <div className='project'>
          <div className='project__text__content'>
            ...
            <p className='project__desc'>
              Buscador de gifs, escribes el gif que quieras buscar y te salen 10 resultados.
            </p>
          ...
          <div className='project__icon__content'>
            <a
              ...
              href='https://github.com/Ismael-Cobo/react-gifexpertapp'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
            ...
            <a
              className='project__icon'
              href='https://ismael-cobo.github.io/react-gifexpertapp/'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
        ...
        <div className='project'>
          <div className='project__text__content'>
            ...
            <h4 className='project__tech'>React, jest, enzyne</h4>
            <p className='project__desc'>
              Es una aplicación que funciona como una lista de tareas, donde puedes añadir estas, marcarlas como
              completadas y eliminarlas.
            </p>
          </div>
          ...
          <div className='project__icon__content'>
            <a
              className='project__icon'
              href='https://github.com/Ismael-Cobo/ToDO-app-and-tests'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
            ...
            <a className='project__icon' href='https://ismaelcobotodoapp.netlify.app/' target='_blank' rel='noreferrer'>
              {' '}
              <MdLiveTv /> live demo
            </a>
          </div>
        ...
        <div className='project'>
          <div className='project__text__content'>
            ...
            <p className='project__desc'>
              Aplicación que te muestra un listado con héroes y si haces clic puedes ver los detalles de cada heroe.
            </p>
          ...
          <div className='project__icon__content'>
            <a
              className='project__icon'
              href='https://github.com/Ismael-Cobo/heroeApp'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
            ...
            <a className='project__icon' href='https://ismaelcoboheroes.netlify.app' target='_blank' rel='noreferrer'>
              {' '}
              <MdLiveTv /> live demo
            </a>
          </div>
        ...
        <div className='project'>
          <div className='project__text__content'>
            ...
            <p className='project__desc'>
              Una aplicación con la función del bloc de notas, con un login y un register en firebase que guarda la
              sesión
            </p>
            <p className='project__desc'>En la aplicación puedes crear, actualizar, ver y eliminar tus notas.</p>
            <p className='project__desc'>
              Por último,un componente de notificaciones personalizadas que funciona con redux.
            </p>
          </div>
          ...
          <div className='project__icon__content'>
            <a
              className='project__icon'
              href='https://github.com/Ismael-Cobo/buleria-app'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
            ...
            <a className='project__icon' href='https://ismaelcobobuleria.netlify.app/' target='_blank' rel='noreferrer'>
              {' '}
              <MdLiveTv /> live demo
            </a>
          </div>
        ...
        <div className='project'>
          <div className='project__text__content'>
            ...
            <p className='project__desc'>
              Calendario con un login y un register en mongodb que guarda la sesión en un token.{' '}
            </p>
        ...
        <div className='project'>
          <div className='project__text__content'>
            ...
            <h4 className='project__tech'>React, context, styled-components</h4>
            <p className='project__desc'>Aplicación para ver el tiempo dependiendo de la ciudad que busques.</p>
            <p className='project__desc'>
              Te muestra la temperatura además de una gráfica de la temperatura en las siguientes horas.{' '}
            </p>
          </div>
          <img className='project__img' src={weather} alt='calendar app img' />
          <div className='project__icon__content'>
            <a
              className='project__icon'
              href='https://github.com/Ismael-Cobo/weather-hackaton'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
            ...
            <a
              className='project__icon'
              href='https://ismaelhackatonweather.netlify.app/'
              target='_blank'
              rel='noreferrer'
            >
              {' '}
